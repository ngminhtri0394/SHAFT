...
chemical_symbols = ['C','O','N','S','B','Li']
battery_symbols = ['S', 'B', 'C', 'N', 'O', 'P', 'Cl', 'Br', 'I', 'Si', 'Be', 'Na', 'Li', 'K']
large_chemical_symbols = ["H",
    "He",
    "Li",
    "Be",
    "B",
    ...
    "Np",
    "Pu"]
# chemical_symbols = ['C','N','Li']
CrystalNN = local_env.CrystalNN(
    distance_cutoffs=None, x_diff_weight=-1, porous_adjustment=False,search_cutoff=20)
